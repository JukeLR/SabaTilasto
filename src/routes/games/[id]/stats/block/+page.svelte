...
let title = 'Vastustajan veto blokattu';
...
async function saveBlock() {
  ...
  payload.blocks = $selectedPlayer !== null ? [$selectedPlayer] : [];
  try {
...
<main class="fp-main">
  ...
  {/each}
  <button class="fp-btn fp-save" on:click={saveBlock} disabled={$selectedPlayer === null}>Tallenna</button>
